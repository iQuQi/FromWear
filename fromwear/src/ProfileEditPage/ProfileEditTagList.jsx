...
let ProfileEditTagList = ({isMobile, target_button,handle_tag_button_click}) => {
            return(
                    <ul >
                    {static_tag_data.map((data,index) =>
                        <li>
                        <Button key={data.name+index} 
                            style={{width: isMobile? 103 :100,height: isMobile? 35 : 40,marginBottom:10,marginRight:8,fontSize: 13,float:"left",
...
export default ProfileEditTagList;
