                    ...
                    <div className = 'banner'>
                        {
                            ...
                            <div className = 'banner_text'>
                                <div style={{marginTop:'20px', marginBottom:'30px'}}>
                                    ...
                                    <span style={{margin:'-2px 0 0 5px', fontSize:'25px', color:'#ffffc6', textShadow:'1px 1px 2px black'}}>TOP4</span>
                                    <span style={{margin:'30px 0px 0px 32px', color:'rgb(82 89 178)'}}>#{weekly_tag[0]} &nbsp;#{weekly_tag[1]}</span>
                                </div>
